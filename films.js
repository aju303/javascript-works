...
// movies.filter(mv=> mv.genres.includes("Comedy")).forEach(mv=>console.log(mv.title))

// no of movies released in 2011

var yearFilter=movies.filter(mv=>mv.year =="2011")
// console.log(yearFilter.length);

// is there an movie released in 2020

var isReleased=movies.some(mv=>mv.year=="2020")
// console.log(isReleased);

// lengthy movie

var longest=movies.reduce((mv1,mv2)=> Number(mv1.runtime) > Number(mv2.runtime) ? mv1 : mv2)
console.log(longest);