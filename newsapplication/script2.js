...
function getNews(){
  ...
  function headlines(data){
    ...
    htmlData+=`
    <div class="card mb-3 ms-5 mt-3 bg-light --bs-bg-opacity:80%;" style="margin-left: 700px; width: 600px;">
    ...
    <div class="card-body">
      ...
      <a href="${url}" class="btn btn-light">click here to read full news</a>
